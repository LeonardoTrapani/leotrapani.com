...
function AppleHelloItalianEffect({
  ...
  return (
    ...
    >
      ...
      {/* C */}
      <motion.path
        d="M80 60C60 60 40 70 30 90C20 110 20 130 30 150C40 170 60 180 80 180C90 180 100 177 110 170"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* i */}
      <motion.path
        d="M140 80L140 180M140 50L140 60"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* a */}
      <motion.path
        d="M190 120C190 95 200 80 220 80C240 80 250 95 250 120L250 180M250 140C245 125 230 115 215 115C200 115 190 125 190 140C190 155 200 165 215 165C230 165 245 155 250 140"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(0.7),
          opacity: { duration: 0.35, delay: calc(0.7) },
        }}
      />

      {/* o */}
      <motion.path
        d="M320 80C300 80 280 95 280 130C280 165 300 180 320 180C340 180 360 165 360 130C360 95 340 80 320 80Z"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(1.1),
          opacity: { duration: 0.3, delay: calc(1.1) },
        }}
        onAnimationComplete={onAnimationComplete}
      />
    </motion.svg>
