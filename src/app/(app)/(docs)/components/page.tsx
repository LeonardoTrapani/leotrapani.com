...
export const metadata: Metadata = {
  title: "Components",
  description: "My collection of reusable components.",
};
      ...
      <div className="p-4">
        <p className="font-mono text-sm text-balance text-muted-foreground">
          ...
          <a
            ...
            href={`https://ui.shadcn.com/docs/directory?q=${registryConfig.namespace}&utm_source=leotrapani.com&utm_medium=referral&utm_campaign=components`}
            target="_blank"
