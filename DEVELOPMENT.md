...
```bash
git clone https://github.com/leonardotrapani/leotrapani.com.git minimal-dev-portfolio
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [leotrapani.com/components](https://leotrapani.com/components) for installation instructions and component documentation.
