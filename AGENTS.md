# AI Agent Guidelines for leotrapani.com

This guide provides essential information for AI agents working with the leotrapani.com codebase - a Next.js dev portfolio, blog, and component registry website.

## Project Overview

**leotrapani.com** is a minimal, pixel-perfect dev portfolio, component registry, and blog built with modern web technologies. It serves as:

- Personal portfolio for Leonardo Trapani (@leo_trapani)
...
packages/
└── leotrapani/                 # Publishable component package
```
